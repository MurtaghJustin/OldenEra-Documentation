...
display names) is in the editor's `KnownValues.KnownSpells`
(`../Olden-Era---Template-Generator/Olden Era - Template Editor/Models/Unfrozen/KnownValues.cs`,
lines ~574–663). A few examples: `primal_4_magic_fire_globe` = Fireball (Primal T2),
